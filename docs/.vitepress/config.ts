...
const SITE_DESCRIPTION =
  "Express-compatible web framework for Bun. Drop-in Express replacement with zero rewrites, zero dependencies, and 26 built-in middleware. Same (req, res, next) API, 3–4× faster.";
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: "Passport",       link: "/middleware/passport" },
              { text: "Token Vault",    link: "/middleware/token-vault" },
