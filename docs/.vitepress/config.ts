...
const SITE_DESCRIPTION = "Express-compatible web framework for Bun. Drop-in Express replacement with zero rewrites, zero dependencies, and 24 built-in middleware. Same (req, res, next) API, 3-4x faster.";
